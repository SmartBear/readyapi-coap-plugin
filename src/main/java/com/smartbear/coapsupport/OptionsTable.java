...
public class OptionsTable extends JTable {
    ...
    public CoapOptionsDataSource getData() {
        return getOptionsTableModel().getDataSource();
    }

    public void setData(CoapOptionsDataSource newData) {
        getOptionsTableModel().setDataSource(newData);
    }
    ...
    protected class OptionsTableModel extends AbstractTableModel implements CoapOptionsListener {
        ...
        public CoapOptionsDataSource getDataSource() {
            return dataSource;
        }
