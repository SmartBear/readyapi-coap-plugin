...
public class CoapResp implements HttpResponse {
    ...
    public CoapResp(CoapRequest request, Response response, long takenTime) {
        ...
        if(response == null){
            ...
            if (response.getPayload() != null){
                ...
                responsePayloadString = new String(responsePayload, Charsets.UTF_8);
            }
